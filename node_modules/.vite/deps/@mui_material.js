...
var Tooltip = React84.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React84.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime73.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime73.jsxs)(React84.Fragment, {
    children: [React84.cloneElement(children, childrenProps), (0, import_jsx_runtime73.jsx)(PopperSlot, {
...
var TablePaginationActions = React111.forwardRef(function TablePaginationActions2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTablePaginationActions"
  });
